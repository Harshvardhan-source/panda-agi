...
class FormulaEvaluator:
    ...
    def convert_formula_to_js(self, formula: str, column_mapping: Dict[str, str]) -> str:
    ...
    def _handle_special_patterns(self, expression: str, column_mapping: Dict[str, str]) -> str:
    ...
    def _replace_column_references(self, expression: str, column_mapping: Dict[str, str]) -> str:
        ...
        custom_range_pattern = r'([a-zA-Z_][a-zA-Z0-9_]{1,})(\d*):([a-zA-Z_][a-zA-Z0-9_]{1,})'
        ...
        for column_name, letter in reverse_mapping.items():
            ...
            column_pattern = r'(?<!getColumnData\(\")\b' + re.escape(column_name) + r'\b(?!\"\))'
            expression = re.sub(column_pattern, f'getColumnData("{column_name}")', expression)
    ...
    def _replace_excel_operators(self, expression: str) -> str:
        ...
        expression = re.sub(data_comparison_pattern, replace_data_comparison, expression)
